...
export default {
  ...
  setup() {
    ...
    const jwt_token = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIzYjBjZmU2Mzc3ZTQ0ODVhYWRhMGI1MjlkYTgyZmE0YyIsInN1YiI6IjEiLCJpc3MiOiJzZyIsImlhdCI6MTc3MjU1NTYzNCwiZXhwIjoxNzczNzY1MjM0fQ.JLNEkN-2_B8RDvGS8nA2hRoOKReEGN_1r8H58V54Pec";
      if (jwt_token) {
